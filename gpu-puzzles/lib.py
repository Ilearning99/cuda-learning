...
# Workaround for Numba CUDA compatibility issue with newer drivers (CUDA 12+).
# cuCtxGetDevice causes an access violation on some driver versions, so fall back
# to device 0 when it fails.
import ctypes
from numba.cuda.cudadrv.driver import driver, _ActiveContext, drvapi
from ctypes import byref

_original_enter = _ActiveContext.__enter__
...
_ActiveContext.__enter__ = _patched_enter
